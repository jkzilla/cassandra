...
public class CassandraVersionTest
{
    ...
    {
        List<CassandraVersion> versionsInOrder = Stream.of("4.0-alpha",
                                                           "4.0-alpha+stargazer_alpha1",
                                                           "4.0-alpha+stargazer_beta",
                                                           "4.0-beta",
                                                           "4.0-beta+stargazer_alpha",
                                                           "4.0-beta+stargazer_beta",
                                                           "4.0",
                                                           "4.0.0.0+stargazer",
                                                           "4.0.1",
                                                           "4.0.1.0+stargazer",
